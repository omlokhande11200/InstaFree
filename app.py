...
def download_reel(url):
    ...
    try:
        ...
        # Transcribe Audio
        transcription = transcribe_audio(new_video_path)
        ...
        return {
            ...
            "video_download_url": f"{base_url}/static/{shortcode}/{shortcode}.mp4",
            "mp3_download_url": f"{base_url}/static/{shortcode}/audio.mp3",
        }
...
def transcribe_audio(video_path):
    """Extract audio from video and transcribe it using Whisper AI."""
    try:
